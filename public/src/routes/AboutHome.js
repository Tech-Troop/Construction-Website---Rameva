    ...
    const optionNames = [
        {
            ...
            optionText1: "At RAMEVA Construction, we are more than just builders - we are creators, dreamers, and visionaries. With a passion for architecture and a commitment to excellence, we specialize in crafting exceptional spaces that inspire and transform. Backed by a team of experienced professionals, we bring together innovative designs."
        },
        {
            ...
            optionText1: "Welcome to RAMEVA Construction, where architecture and construction converge to redefine what's possible. With a rich legacy of successful projects and a client-focused approach, we have established ourselves as a trusted name in the industry. "
        },
        {
            optionName: "REVIEWS",
            ...
            optionText1: "At RAMEVA Construction, we offer a comprehensive range of services to cater to all your construction needs. From initial planning and design to construction management and post-construction services, our team has the expertise and experience to handle projects."
        }
    ];
        ...
        <div className={styles.mainContainer}>
            ...
            <div className={styles.optionContainer}>
                ...
                <div className={styles.optionContext}>
                    ...
                    <ul>
                        <li><i className='fas fa-chevron-right'></i> Company Mission and Values</li>
                        <li><i className='fas fa-chevron-right'></i>Expertise and Innovation</li>
                        <li><i className='fas fa-chevron-right'></i>Experience and Client Focus</li>
                    </ul>
                </div>
            </div>
        </div>
